# Source Ingest Log — Horner Civil War Archive

**Purpose:** Chain of custody for deposited sources. One row per artifact in `sources/` or linked grant-readiness materials.

| Date | Source | Provider / origin | Repo path | Tier | OQ / section | Permission / notes |
|------|--------|-------------------|-----------|------|--------------|-------------------|
| 2026-06 | 1942 Horner transcript excerpts | FindAGrave #9297073 (privately held copy cited) | `sources/1942_transcript_excerpts.txt`, `transcript-1942.html` | Oral | §07, §13 | Excerpts only; **full transcript custody open** |
| 2026-06 | 1860 Floyd Township census images | Researcher-held scan (Google Doc export) | `sources/census-1860/` | Primary | OQ-21 closed | Published v20.5 |
| 2026-06 | 1860 census analysis PDF | Daniel Lingar | `sources/1860-floyd-township-census-analysis.pdf` | Secondary | §04c | Derived analysis |
| 2026-06 | CMSR research OQ-12/OQ-13 | NARA index + Fold3/UDC corroboration | `sources/cmsr-oq12-oq13.md` | Primary | OQ-12 closed, OQ-13 partial | M317 card images optional |
...
| — | Wash Middleton dossier | Daniel Lingar | `people/wash-middleton/` | Oral + Primary | OQ-14 | Published |

## Intake rules

1. New files land in `00_INBOX/` first; move to `sources/` only after this log row exists.
2. Record **who** provided the file, **when**, and whether permission covers public GitHub Pages.
3. Link every deposit to an OQ ID or site section.
4. Oral/family materials require tier label before publish.
...
- NARA RG 94 Special Order Bo-276-66 (OQ-16)
- Full 1942 transcript scan with deposit permission
- Henry Stewart M317 CMSR card image (Fold3)